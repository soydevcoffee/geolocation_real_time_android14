...
All new issues should follow instructions in [ISSUE_TEMPLATE.md](https://raw.githubusercontent.com/soydevcoffee/react-native-background-geolocation/master/ISSUE_TEMPLATE.md).
...
Fund your issues or feature request to drag attraction of developers. Checkout our [issue hunt page](https://issuehunt.io/r/soydevcoffee/react-native-background-geolocation/issues).
...
## Description
React Native fork of [cordova-plugin-background-geolocation](https://github.com/soydevcoffee/cordova-plugin-background-geolocation)
...
The repository [react-native-background-geolocation-example](https://github.com/soydevcoffee/react-native-background-geolocation-example) hosts an example app for both iOS and Android platform.
...
import BackgroundGeolocation from '@soydevcoffee/react-native-background-geolocation';
...
```
yarn add @soydevcoffee/react-native-background-geolocation
```
...
```
node ./node_modules/@soydevcoffee/react-native-background-geolocation/scripts/postlink.js
```
...
```gradle
...
include ':@soydevcoffee_react-native-background-geolocation-common'
project(':@soydevcoffee_react-native-background-geolocation-common').projectDir = new File(rootProject.projectDir, '../node_modules/@soydevcoffee/react-native-background-geolocation/android/common')
include ':@soydevcoffee_react-native-background-geolocation'
project(':@soydevcoffee_react-native-background-geolocation').projectDir = new File(rootProject.projectDir, '../node_modules/@soydevcoffee/react-native-background-geolocation/android/lib')
...
```
...
dependencies {
    ...
    compile project(':@soydevcoffee_react-native-background-geolocation')
    ...
}
```
...
2. Add `./node_modules/@soydevcoffee/react-native-background-geolocation/ios/RCTBackgroundGeolocation.xcodeproj`
...
*[Example of infinite log scrolling](https://github.com/soydevcoffee/react-native-background-geolocation-example/blob/master/src/scenes/Logs.js)
...
[Background-geolocation-server](https://github.com/soydevcoffee/background-geolocation-server) is a backend server written in nodejs with CORS - Cross-Origin Resource Sharing support.
